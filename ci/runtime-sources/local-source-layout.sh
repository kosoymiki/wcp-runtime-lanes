...
: "${WCP_LOCAL_WINE11_FALLBACK_DIR:=${WCP_LOCAL_FREEWINE11_DIR}}"
# Backward-compat aliases kept for older callers.
: "${WCP_LOCAL_ANDRE_WINE11_DIR:=${WCP_LOCAL_WINE11_FALLBACK_DIR}}"
: "${WCP_LOCAL_VALVE_WINE_EXP10_DIR:=${WCP_LOCAL_SOURCE_ROOT}/valve-wine-experimental10}"
: "${WCP_LOCAL_WINE11_DONOR_DIR:=${WCP_LOCAL_WINE11_FALLBACK_DIR}}"
